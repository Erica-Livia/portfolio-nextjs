    ...
    return (
        <div className="relative group pt-2 pb-8">
            <div className="overflow-hidden">
                <Image src={image} className="w-full transition-transform duration-300 " alt={title} width={100} height={100}/>
                <div
                    className="absolute -top-0 inset-0 flex flex-col items-center justify-center bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
